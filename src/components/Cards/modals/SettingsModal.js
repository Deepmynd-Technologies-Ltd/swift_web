    ...
    <div className="bg-blueGray-600 text-aeonik h-screen w-full z-10 flex justify-center items-center"
      ...
      >
        ...
        <div className="flex flex-col px-6 pb-6">
          ...
          {/* Currency */}
          <div className="flex justify-between items-center mb-6 font-bold text-white">
            <div className="text-lg text-white">Currency</div>
            <div className="flex items-center bg-primary-color rounded-lg px-4 py-2">
          ...
          <div className="flex justify-between items-center mb-6 text-white">
            <div className="text-lg text-white font-bold">Push notifications</div>
            <div
              className={`w-12 h-6 rounded-full flex items-center px-1 cursor-pointer ${pushNotifications ? 'bg-green-500 justify-end' : 'bg-primary-color justify-start'}`}
          ...
          {/* Search Engine */}
          <div className="flex justify-between items-center mb-6 font-bold text-white">
            <div className="text-lg text-white">Search Engine</div>
            <div className="flex items-center bg-primary-color rounded-lg px-4 py-2">
          ...
          {/* Language */}
          <div className="flex justify-between items-center mb-6 font-bold text-white">
            <div className="text-lg text-white">Language</div>
            <div className="flex items-center bg-primary-color rounded-lg px-4 py-2">
          ...
          <div className="flex justify-between items-center mb-6 font-bold">
            <div className="text-lg text-white">Payment Timeout</div>
            <div className="text-lg text-white">15 minutes</div>
          </div>
          ...
          <div className="flex justify-between items-center mb-4 py-2 font-bold">
            <div className="text-lg text-white">Backup</div>
          ...
          <div className="flex justify-between items-center mb-4 py-2 font-bold">
            <div className="text-lg text-white">Secure with Passcode</div>
            <div
              className={`w-12 h-6 rounded-full flex items-center px-1 cursor-pointer ${secureWithPasscode ? 'bg-green-500 justify-end' : 'bg-primary-color justify-start'}`}
          ...
          {/* Secure with Face ID */}
          <div className="flex justify-between items-center mb-4 py-2 font-bold">
            <div className="text-lg text-white">Secure with Face ID</div>
            <div
              className={`w-12 h-6 rounded-full flex items-center px-1 cursor-pointer ${secureWithFaceID ? 'bg-green-500 justify-end' : 'bg-primary-color justify-start'}`}
          ...
          <div className="flex justify-between items-center mb-4 py-2">
            <div className="text-lg text-white font-bold">FAQ</div>
            <span className="text-3xl">→</span>
          </div>
          <div className="border-b border-gray-200 mb-4"></div>
          ...
          {/* Contact Us */}
          <div className="flex justify-between items-center mb-4 py-2">
            <div className="text-lg text-white font-bold">Contact Us</div>
            <span className="text-3xl">→</span>
          </div>
          <div className="border-b border-gray-200 mb-4"></div>
          ...
          {/* Rate SwiftAza */}
          <div className="flex justify-between items-center mb-4 py-2">
            <div className="text-lg text-white font-bold">Rate SwiftAza</div>
            <span className="text-3xl">→</span>
          </div>
          <div className="border-b border-gray-200 mb-4"></div>
          ...
          <div className="flex justify-between items-center mb-8 py-2">
            <div className="text-lg text-white font-bold">Privacy Policy</div>
            <span className="text-3xl">→</span>
          </div>

          {/* Sign Out */}
          <div className="flex justify-center items-center text-red-500 py-2 cursor-pointer justify-between" onClick={handleLogout}>
